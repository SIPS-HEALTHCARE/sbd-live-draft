...
const TOUR_STEPS = {
  admin: [
    ...
    { target:'[data-view="a-instruments"]', title:'SBD Instruments', desc:'SBD Instruments are the three assessment gates — Competency, Simulation, and Observation. This view shows each staff member\'s assignment status and their three-pass progress (X/3) toward the belt. The three-pass rule and the belt star update automatically as gates pass. Assignments themselves are created by facility leaders and master admins.', group:'Development' },
  ...
  hospital: [
    ...
    { target:'[data-view="h-instruments"]', title:'SBD Instruments', desc:'SBD Instruments are the three assessment gates — Competency, Simulation, and Observation. Here you can monitor each staff member\'s assignment status and their three-pass progress (X/3). Assigning and scoring are handled by your Facility Admin and assessors.', group:'Development' },
  ...
  facility_admin: [
    ...
    { target:'[data-view="h-instruments"]', title:'SBD Instruments', desc:'SBD Instruments are the three assessment gates — Competency, Simulation, and Observation. Assign instruments to your staff and track each person\'s three-pass progress (X/3) toward promotion. The three-pass rule and the belt star update automatically as gates pass.', group:'Development' },
  ...
  staff_member: [
    ...
    { target:'[data-view="s-instruments"]', title:'SBD Instruments', desc:'SBD Instruments are your three assessment gates — Competency, Simulation, and Observation. Track your three-pass progress (X/3) here; you earn your belt star once all three pass.', group:'Learning' },
