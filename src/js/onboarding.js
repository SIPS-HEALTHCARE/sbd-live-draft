...
const NAV_REGISTRY = {
  admin: [
    ...
    { target:'[data-view="a-scripts"]', title:'SPD Language', desc:'SPD Language is the communication standard as a module of its own, for someone who has passed their belts but needs to refine their delivery. It is assigned by name, never as a belt requirement, and this view shows who holds it across the network and who has completed it. SPD Language is spoken delivery with no question bank, so a leader marks the module complete once the delivery meets the approved language.', group:'Development' },
  ...
  hospital: [
    ...
    { target:'[data-view="h-scripts"]', title:'SPD Language', desc:'SPD Language is the communication standard as a module of its own, for someone who has passed their belts but needs to refine their delivery. It is assigned by name, never as a belt requirement. Here you can see which of your staff hold it and who has completed it. SPD Language has no question bank, so completion is marked by a leader once the delivery meets the approved language.', group:'Development' },
  ...
  staff_member: [
    ...
    { target:'[data-view="s-scripts"]', title:'SPD Language', desc:'SPD Language is your communication standard as a module of its own, assigned to you by your leader to refine your delivery. Pick a belt to review its approved language and practise it aloud. There is no quiz here; your leader marks the module complete once your delivery meets the approved language.', group:'Learning' },
