...
const FOUNDATIONS_MODULES = [
 ...
 {id:'fm-02',num:2,title:'Decontamination',subtitle:'The Foundation of Safe Processing',domain:'Cleaning',
  ...
  sectionContent:[
    '<p class="fnd-intro">The decontamination area is considered "dirty". You will be handling items contaminated with blood, body fluids, and potentially infectious material. Proper PPE protects you from exposure.</p><div class="fnd-h">Required PPE</div><div class="fnd-tw"><table class="fnd-table"><thead><tr><th>PPE Item</th><th>Purpose</th><th>Key Points</th></tr></thead><tbody><tr><td><b>Fluid-Resistant Gown</b></td><td>Protects clothing and skin from splashes</td><td>Must cover arms fully; ties in back; disposable or laundered</td></tr><tr><td><b>Heavy-Duty Gloves</b></td><td>Protects hands from sharps, chemicals, contamination</td><td>Thicker than exam gloves; check for tears before use; change when torn</td></tr><tr><td><b>Face Shield OR Goggles + Mask</b></td><td>Protects eyes, nose, mouth from splashes</td><td>Full face shield preferred; if goggles, must add surgical mask</td></tr><tr><td><b>Fluid-Resistant Shoe Covers</b></td><td>Protects shoes; prevents tracking contamination</td><td>Cover entire shoe; change if wet or visibly soiled</td></tr><tr><td><b>Hair Cover (Bouffant)</b></td><td>Contains hair; prevents contamination</td><td>Must cover all hair; replace if it falls off</td></tr><tr><td><b>Sleeve Protectors (as needed)</b></td><td>Additional arm protection for heavy splash work</td><td>Used in addition to gown when extended arm immersion expected</td></tr></tbody></table></div><div class="fnd-h">Donning Sequence (Putting On)</div><p class="fnd-sub">Put on PPE in this order to maximize protection:</p><div class="fnd-step"><div class="fnd-step-n">STEP 1</div><div class="fnd-step-b"><div class="fnd-step-t">Hair Cover</div><div class="fnd-step-d">Place bouffant cap over all hair. Tuck in any stray hairs.</div></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 2</div><div class="fnd-step-b"><div class="fnd-step-t">Shoe Covers</div><div class="fnd-step-d">Place over shoes, ensuring complete coverage. Stand on clean surface after applying.</div></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 3</div><div class="fnd-step-b"><div class="fnd-step-t">Gown</div><div class="fnd-step-d">Put on fluid-resistant gown. Tie at neck and waist. Ensure arms are fully covered.</div></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 4</div><div class="fnd-step-b"><div class="fnd-step-t">Mask/Respirator (if separate)</div><div class="fnd-step-d">Place over nose and mouth. Secure ties or ear loops. Mold nose piece.</div></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 5</div><div class="fnd-step-b"><div class="fnd-step-t">Eye Protection</div><div class="fnd-step-d">Put on goggles or face shield. Ensure seal around eyes.</div></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 6</div><div class="fnd-step-b"><div class="fnd-step-t">Gloves</div><div class="fnd-step-d">Put on heavy-duty gloves LAST. Pull glove cuffs over gown cuffs.</div></div></div><div class="fnd-note fnd-note-tip"><div class="fnd-note-t">Gloves Over Gown Cuffs</div><div class="fnd-note-b">Always pull your glove cuffs OVER your gown cuffs. This prevents fluids from running down into your gloves and onto your skin.</div></div><div class="fnd-h">Doffing Sequence (Taking Off)</div><p class="fnd-sub">Remove PPE in this order to prevent self-contamination. The outside of your PPE is contaminated, so avoid touching it with bare hands.</p><div class="fnd-step"><div class="fnd-step-n">STEP 1</div><div class="fnd-step-b"><div class="fnd-step-t">Gloves</div><ul class="fnd-ul"><li>Grasp outside of one glove at wrist</li><li>Peel off, turning inside out</li><li>Hold removed glove in gloved hand</li><li>Slide finger under remaining glove at wrist</li><li>Peel off over first glove, creating a ball</li><li>Dispose in appropriate container</li></ul></div></div><div class="fnd-act">PERFORM HAND HYGIENE</div><div class="fnd-step"><div class="fnd-step-n">STEP 2</div><div class="fnd-step-b"><div class="fnd-step-t">Face Shield/Goggles</div><ul class="fnd-ul"><li>Grasp the strap or earpieces (not the front)</li><li>Lift away from face</li><li>Dispose or place in designated bin for cleaning</li></ul></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 3</div><div class="fnd-step-b"><div class="fnd-step-t">Gown</div><ul class="fnd-ul"><li>Unfasten ties</li><li>Pull gown away from body, touching only inside</li><li>Turn inside out while removing</li><li>Roll into a bundle</li><li>Dispose in appropriate container</li></ul></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 4</div><div class="fnd-step-b"><div class="fnd-step-t">Mask (if separate)</div><ul class="fnd-ul"><li>Grasp ties or ear loops only (not front of mask)</li><li>Remove by lifting away from face</li><li>Dispose</li></ul></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 5</div><div class="fnd-step-b"><div class="fnd-step-t">Shoe Covers</div><ul class="fnd-ul"><li>Remove one at a time</li><li>Step onto clean surface with uncovered foot</li><li>Remove second cover</li><li>Dispose</li></ul></div></div><div class="fnd-step"><div class="fnd-step-n">STEP 6</div><div class="fnd-step-b"><div class="fnd-step-t">Hair Cover</div><ul class="fnd-ul"><li>Grasp top of bouffant</li><li>Lift off head</li><li>Dispose</li></ul></div></div><div class="fnd-act">PERFORM HAND HYGIENE AGAIN</div><div class="fnd-note fnd-note-warn"><div class="fnd-note-t">The Golden Rule of Doffing</div><div class="fnd-note-b">The OUTSIDE of your PPE is contaminated. The INSIDE is clean. Always touch only the inside or the ties and straps when removing.</div></div>',
...
function fndFmtBody(txt){
  if(!txt) return '';
  // A section whose content is already authored as HTML passes straight through.
  // This is how a section carries the full source document, tables and steps and
  // callouts included, rather than the one paragraph summary. Without this guard
  // the sentence splitter below would tear the markup apart.
  if(/^\s*<(p|div|table|ul|ol|h[1-6])[\s>]/i.test(String(txt))) return String(txt);
