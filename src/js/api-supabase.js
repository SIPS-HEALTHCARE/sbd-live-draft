...
const SB = {
  ...
  // ── Hospital Systems ──
  getHospitalSystems(){ return sbFetch('/rest/v1/hospital_systems?select=*&order=name.asc'); },
  createHospitalSystem(data){ return sbFetch('/rest/v1/hospital_systems', { method:'POST', body:data }); },
  updateHospitalSystem(id, data){ return sbFetch(`/rest/v1/hospital_systems?id=eq.${id}`, { method:'PATCH', body:data }); },
  // ── Free Agents ──
