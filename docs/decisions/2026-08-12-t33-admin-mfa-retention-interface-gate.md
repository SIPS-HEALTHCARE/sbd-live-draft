...
**Date:** 2026-08-12 · **Status:** implemented, pending user deploy · **Task:** TASKS.md T33 (committed for Wed 29 July, oldest slip)
...
- `src/js/mfa.js` (new), `src/js/ui-views.js` (doLogin hook), `index.html` (script
  tag + cache-bust).
- Migration `20260812130000_t33_admin_mfa_aal2_gate.sql`: new fn
...
4. Apply migration `20260812130000_t33_admin_mfa_aal2_gate.sql` — this is the
...
exact list), recreate `sbd_is_admin()` from `20260723130000`, and
